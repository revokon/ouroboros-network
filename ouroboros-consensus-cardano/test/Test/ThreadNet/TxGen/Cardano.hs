...
instance ( TPraosCrypto c
           -- These equalities allow use of Byron bootstrap addresses in the
           -- Shelley era, since @shelley-spec-ledger@ requires Ed25519 and the
           -- current Byron-to-Shelley translation requires a 224-bit hash.
